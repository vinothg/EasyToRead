...
import com.dyslexia.ocr.CaptureActivity;
  ...
  public void handleMessage(Message message) {
    ...
    switch (message.what) {
      ...
      case R.id.ocr_decode_failed:
        state = State.PREVIEW;
        activity.setShutterButtonClickable(true);
        Toast toast = Toast.makeText(activity.getBaseContext(), "Image recognition failed. Please try again.", Toast.LENGTH_SHORT);
