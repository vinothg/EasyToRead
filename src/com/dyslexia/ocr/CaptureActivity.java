...
import com.dyslexia.ocr.BeepManager;
import com.dyslexia.ocr.HelpActivity;
import com.dyslexia.ocr.OcrResult;
import com.dyslexia.ocr.PreferencesActivity;
import com.dyslexia.ocr.R;
import com.dyslexia.ocr.camera.CameraManager;
import com.dyslexia.ocr.camera.ShutterButton;
import com.dyslexia.ocr.language.LanguageCodeHelper;
import com.dyslexia.ocr.language.TranslateAsyncTask;
...
public final class CaptureActivity extends Activity implements SurfaceHolder.Callback, 
  ShutterButton.OnShutterButtonListener, OnInitListener{
  ...
  private static final int OPTIONS_VOICE_RECOGNIZED_TEXT_ID = Menu.FIRST + 4;
...
//  private ToggleButton torchButton;
  ...
  void onShutterButtonPressContinuous() {
    ...
    if (lastResult != null) {
      ...
      Toast toast = Toast.makeText(this, "Image recognition failed. Please try again.", Toast.LENGTH_SHORT);
...
//    }
    ...
    indeterminateDialog.setMessage("Easy to Read is Loading.Please wait...");
  ...
  boolean handleOcrDecode(OcrResult ocrResult) {
    ...
    int scaledSize = Math.max(32, 42 - ocrResult.getText().length() / 4);
    ocrResultTextView.setTextSize(TypedValue.COMPLEX_UNIT_SP, scaledSize);
    mToRead = lastResult.getText();
    
    Typeface type = Typeface.createFromAsset(getAssets(),"fonts/font.ttf"); 
    ocrResultTextView.setTypeface(type);
  ...
  public void onCreateContextMenu(ContextMenu menu, View v,
    ...
    if (v.equals(ocrResultView)) {
      menu.add(Menu.NONE, OPTIONS_VOICE_RECOGNIZED_TEXT_ID, Menu.NONE, "Voice Playback");
  ...
  public boolean onContextItemSelected(MenuItem item) {
    ...
    case OPTIONS_SHARE_TRANSLATED_TEXT_ID:
    	...
    	return true;
    case OPTIONS_VOICE_RECOGNIZED_TEXT_ID:
		...
		mTts.speak(mToRead, TextToSpeech.QUEUE_FLUSH, null);
    	return true;
    default:
...
//    }
    ...
    indeterminateDialog.setMessage("Performing Image Recognition");
